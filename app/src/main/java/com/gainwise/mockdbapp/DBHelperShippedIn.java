...
public class DBHelperShippedIn extends SQLiteOpenHelper {
    ...
    public DBHelperShippedIn(Context context) throws IOException {
        ...
        if (dbexist) {
            Log.i("MOCKDB ", "database exists1");
            opendatabase();
        } else {
            Log.i("MOCKDB ", "database doesn't exists1");
            createdatabase();
        }
    ...
    public void createdatabase() throws IOException {
        boolean dbexist = checkdatabase();
        if (dbexist) {
            Log.i("MOCKDB ", "database exists2");
        } else {
            this.getReadableDatabase();
            try {
                copydatabase();
            } catch (IOException e) {
                Log.i("MOCKDB", e.getMessage());
    ...
    private boolean checkdatabase() {
        ...
        try {
            ...
            Log.i("MOCKDB ", "database doesn't exists");
        }
    ...
    private void copydatabase() throws IOException {
        ...
        OutputStream myoutput = new FileOutputStream("/data/data/com.gainwise.mockdbapp/databases/"+DB_NAME_OUT);
